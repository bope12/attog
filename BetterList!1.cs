...
public class BetterList<T>
{
    ...
    [CompilerGenerated]
    private sealed class MUHITER2<T> : IEnumerator, IDisposable, IEnumerator<T>
    {
        internal T scurrent;
        internal int SPC;
        internal BetterList<T> FUCKTHIS;
        internal int INTO;
        ...
        public bool MoveNext()
        {
            ...
            if (this.INTO < this.FUCKTHIS.size)
            {
                this.scurrent = this.FUCKTHIS.buffer[this.INTO];
                this.SPC = 1;
                return true;
            }
        Label_0089:
