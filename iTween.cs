...
public class iTween : MonoBehaviour
{
    public string _name;
    [CompilerGenerated]
    private static Dictionary<string, int> SWITCHSMAP10;
    [CompilerGenerated]
    private static Dictionary<string, int> SWITCHSMAP11;
    [CompilerGenerated]
    private static Dictionary<string, int> SWITCHSMAP12;
    [CompilerGenerated]
    private static Dictionary<string, int> SWITCHSMAP13;
    [CompilerGenerated]
    private static Dictionary<string, int> SWITCHSMAP14;
    [CompilerGenerated]
    private static Dictionary<string, int> SWITCHSMAP8;
    [CompilerGenerated]
    private static Dictionary<string, int> SWITCHSMAP9;
    [CompilerGenerated]
    private static Dictionary<string, int> SWITCHSMAPA;
    [CompilerGenerated]
    private static Dictionary<string, int> SWITCHSMAPB;
    [CompilerGenerated]
    private static Dictionary<string, int> SWITCHSMAPC;
    [CompilerGenerated]
    private static Dictionary<string, int> SWITCHSMAPD;
    [CompilerGenerated]
    private static Dictionary<string, int> SWITCHSMAPE;
    [CompilerGenerated]
    private static Dictionary<string, int> SWITCHSMAPF;
    ...
    private static Hashtable CleanArgs(Hashtable args)
    {
        ...
        foreach (DictionaryEntry entry3 in args)
        {
    ...
    private void GenerateLookToTargets()
    {
        ...
        if (this.tweenArguments.Contains("axis"))
        {
            ...
            {
                int num2;
                if (SWITCHSMAP13 == null)
                {
                    Dictionary<string, int> dictionary = new Dictionary<string, int>(3);
                    dictionary.Add("x", 0);
                    dictionary.Add("y", 1);
                    dictionary.Add("z", 2);
                    SWITCHSMAP13 = dictionary;
                }
                if (SWITCHSMAP13.TryGetValue(key, out num2))
                {
                    switch (num2)
                    {
                        case 0:
    ...
    private void GenerateTargets()
    {
        ...
        if (type != null)
        {
            ...
            if (SWITCHSMAP12 == null)
            {
                ...
                SWITCHSMAP12 = dictionary;
            }
            if (SWITCHSMAP12.TryGetValue(type, out num))
            {
                string method;
                int num2;
                switch (num)
                {
                    case 0:
                        ...
                        if (method != null)
                        {
                            if (SWITCHSMAP9 == null)
                            {
                                ...
                                SWITCHSMAP9 = dictionary;
                            }
                            if (SWITCHSMAP9.TryGetValue(method, out num2))
                            {
                                switch (num2)
                                {
                                    case 0:
                    ...
                    case 1:
                        ...
                        if (method != null)
                        {
                            if (SWITCHSMAPA == null)
                            {
                                ...
                                dictionary.Add("to", 0);
                                SWITCHSMAPA = dictionary;
                            }
                            if (SWITCHSMAPA.TryGetValue(method, out num2) && (num2 == 0))
                            {
                    ...
                    case 2:
                        ...
                        if (method != null)
                        {
                            if (SWITCHSMAPB == null)
                            {
                                dictionary = new Dictionary<string, int>(1);
                                dictionary.Add("to", 0);
                                SWITCHSMAPB = dictionary;
                            }
                            if (SWITCHSMAPB.TryGetValue(method, out num2) && (num2 == 0))
                            {
                    ...
                    case 3:
                        ...
                        if (method != null)
                        {
                            if (SWITCHSMAPC == null)
                            {
                                ...
                                SWITCHSMAPC = dictionary;
                            }
                            if (SWITCHSMAPC.TryGetValue(method, out num2))
                            {
                                if (num2 == 0)
                                {
                    ...
                    case 4:
                        ...
                        if (method != null)
                        {
                            if (SWITCHSMAPD == null)
                            {
                                ...
                                SWITCHSMAPD = dictionary;
                            }
                            if (SWITCHSMAPD.TryGetValue(method, out num2))
                            {
                                switch (num2)
                                {
                                    case 0:
                    ...
                    case 5:
                        ...
                        if (method != null)
                        {
                            if (SWITCHSMAPE == null)
                            {
                                ...
                                dictionary.Add("add", 1);
                                dictionary.Add("by", 2);
                                SWITCHSMAPE = dictionary;
                            }
                            if (SWITCHSMAPE.TryGetValue(method, out num2))
                            {
                                switch (num2)
                                {
                                    case 0:
                    ...
                    case 6:
                        ...
                        if (method != null)
                        {
                            if (SWITCHSMAPF == null)
                            {
                                ...
                                SWITCHSMAPF = dictionary;
                            }
                            if (SWITCHSMAPF.TryGetValue(method, out num2))
                            {
                                switch (num2)
                                {
                                    case 0:
                    ...
                    case 7:
                        ...
                        if (method != null)
                        {
                            if (SWITCHSMAP10 == null)
                            {
                                dictionary = new Dictionary<string, int>(3);
                                dictionary.Add("position", 0);
                                dictionary.Add("rotation", 1);
                                dictionary.Add("scale", 2);
                                SWITCHSMAP10 = dictionary;
                            }
                            if (SWITCHSMAP10.TryGetValue(method, out num2))
                            {
                                switch (num2)
                                {
                                    case 0:
                    ...
                    case 8:
                        ...
                        if (method != null)
                        {
                            if (SWITCHSMAP11 == null)
                            {
                                dictionary = new Dictionary<string, int>(1);
                                dictionary.Add("to", 0);
                                SWITCHSMAP11 = dictionary;
                            }
                            if (SWITCHSMAP11.TryGetValue(method, out num2) && (num2 == 0))
                            {
        ...
        if (args.Contains("axis"))
        {
            ...
            if (key != null)
            {
                ...
                if (SWITCHSMAP8 == null)
                {
                    ...
                    dictionary.Add("y", 1);
                    dictionary.Add("z", 2);
                    SWITCHSMAP8 = dictionary;
                }
                if (SWITCHSMAP8.TryGetValue(key, out num))
                {
                    switch (num)
                    {
                        case 0:
    ...
    public static void LookUpdate(GameObject target, Hashtable args)
    {
        ...
        if (args.Contains("axis"))
        {
            ...
            {
                int num2;
                if (SWITCHSMAP14 == null)
                {
                    Dictionary<string, int> dictionary = new Dictionary<string, int>(3);
                    dictionary.Add("x", 0);
                    dictionary.Add("y", 1);
                    dictionary.Add("z", 2);
                    SWITCHSMAP14 = dictionary;
                }
                if (SWITCHSMAP14.TryGetValue(key, out num2))
                {
                    switch (num2)
                    {
                        case 0:
    ...
    {
        STARTCITERATOR5 iterator = new STARTCITERATOR5();
    ...
    {
        TWEENDELAY3 iterator = new TWEENDELAY3();
        iterator.FUCKTHIS = this;
        return iterator;
    }
    ...
    {
        TWEENRESTART4 iterator = new TWEENRESTART4();
        iterator.FUCKTHIS = this;
        return iterator;
    }
    ...
    [CompilerGenerated]
    private sealed class STARTCITERATOR5 : IEnumerator<object>, IDisposable, IEnumerator
    {
        internal object scurrent;
        internal int SPC;
        internal iTween FUCKTHIS;
        ...
        public bool MoveNext()
        {
            ...
            {
                case 0:
                    if (this.FUCKTHIS.delay <= 0f)
                    {
                        break;
                    }
                    this.scurrent = this.FUCKTHIS.StartCoroutine("TweenDelay");
                    this.SPC = 1;
                    return true;
    ...
    [CompilerGenerated]
    private sealed class TWEENDELAY3 : IEnumerator, IDisposable, IEnumerator<object>
    {
        internal object scurrent;
        internal int SPC;
        internal iTween FUCKTHIS;
        ...
        public bool MoveNext()
        {
            ...
            {
                case 0:
                    this.FUCKTHIS.delayStarted = Time.time;
                    this.scurrent = new WaitForSeconds(this.FUCKTHIS.delay);
                    this.SPC = 1;
                    return true;

                case 1:
                    if (this.FUCKTHIS.wasPaused)
                    {
                        this.FUCKTHIS.wasPaused = false;
                        this.FUCKTHIS.TweenStart();
                    }
                    this.SPC = -1;
                    break;
    ...
    [CompilerGenerated]
    private sealed class TWEENRESTART4 : IEnumerator<object>, IDisposable, IEnumerator
    {
        internal object scurrent;
        internal int SPC;
        internal iTween FUCKTHIS;
